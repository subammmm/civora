        ...
        <div className="container text-center">
          <div className="card reveal">
            ...
            <div className="stats-grid">
              ...
              <div className="stat-card fade-in">
                <i
                  className="fas fa-trophy icon"
                  style={{ fontSize: '2rem', marginBottom: '1rem' }}
                  aria-hidden="true"
                ></i>
                <span className="stat-number" data-count="35">
                  0
                </span>
              ...
              <div className="stat-card fade-in">
                <i
                  ...
                  aria-hidden="true"
                ></i>
                <span className="stat-number" data-count="18">
                  0
                </span>
          ...
          <div className="feature-grid">
            <div className="feature-card hover-lift card reveal">
              ...
              <p data-i18n="index.card_sch_desc">
                Discover and compare scholarships tailored for Nepali students. Access up-to-date
                information, eligibility criteria, and application deadlines in one place.
              </p>
              <img
            ...
            <div className="feature-card hover-lift card reveal">
              ...
              <p data-i18n="index.card_guides_desc">
                Step-by-step guides to help you complete scholarship and university applications
                with confidence. Get tips, document checklists, and expert advice tailored for
                Nepali students.
              </p>
              <img
            ...
            <div className="feature-card hover-lift card reveal">
              ...
              <p data-i18n="index.card_cit_desc">
                Explore citizenship and visa options for Nepali students. Get guidance on legal
                pathways, documentation, and opportunities for studying and living abroad.
              </p>
              <img
            ...
            <div className="feature-card hover-lift card reveal">
              ...
              <p data-i18n="index.card_stories_desc">
                Learn from students who have successfully navigated the scholarship and visa
                process. Real experiences, practical tips, and insights from Nepali students
                studying worldwide.
              </p>
              <img
            ...
            <div className="timeline">
              <div className="timeline-step">
                ...
                <div className="step-content">
                  ...
                  <p>
                    Every scholarship opportunity is manually verified and updated regularly. We
                    cross-reference with official sources to ensure accuracy.
                  </p>
                </div>
              </div>
              <div className="timeline-step">
                ...
                <div className="step-content">
                  ...
                  <p>
                    Our database considers academic background, financial need, destination
                    preferences, and eligibility criteria to help students find the most relevant
                    opportunities.
                  </p>
                </div>
              </div>
              <div className="timeline-step">
                ...
                <div className="step-content">
                  ...
                  <p>
                    We regularly update our guidance and resources based on feedback and the latest
