...
export const metadata = {
  ...
  keywords: ['nepal scholarships', 'nepali students abroad', 'international scholarships', 'study abroad nepal', 'student visa nepal', 'citizenship pathways', 'university scholarships', 'graduate scholarships', 'undergraduate scholarships', 'scholarship database'],
  authors: [{ name: 'Civora' }],
  creator: 'Civora',
  publisher: 'Civora',
  robots: {
  ...
  openGraph: {
    ...
    description: 'Civora is a research-driven hub for Nepali students: verified scholarships, clear visa and residency pathways, and practical templates.',
    images: [
      {
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@400;600;700;800&family=Inter:wght@400;600;700;800&display=swap" rel="stylesheet" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              '@type': 'WebSite',
              name: 'Civora',
              description: 'Opening doors for Nepali students to study, work, and belong anywhere in the world',
              url: 'https://civora.me',
              potentialAction: {
                '@type': 'SearchAction',
    ...
    <header className="site-header">
      <div className="header-inner">
        ...
        <nav className="site-nav">
          ...
          <a href="/citizenship/" className="nav-item">Citizenship</a>
          <a href="/students-supported/" className="nav-item">Students & Stories</a>
          <a href="/ielts-prep/" className="nav-item">IELTS & Prep</a>
    ...
    <footer className="site-footer">
      <div className="footer-inner">
        ...
        <div className="footer-right">
          ...
          <a href="https://linkedin.com/company/civora" className="social-icon" target="_blank" rel="noopener" aria-label="LinkedIn">
