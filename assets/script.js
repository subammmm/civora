...
const I18N = {
  en: {
    ...
    // New 6 categories
    'index.card_sch_title': 'Scholarship Database',
    'index.card_sch_desc': 'Verified opportunities from government and university programs worldwide.',
    'index.card_visa_title': 'Visa & Immigration',
    'index.card_visa_desc': 'Step-by-step pathways for student visas, work permits, and residency.',
    'index.card_prep_title': 'Test Preparation',
    'index.card_prep_desc': 'IELTS, TOEFL, and other standardized test resources.',
    'index.card_finance_title': 'Financial Planning',
    'index.card_finance_desc': 'Budgeting tools, scholarship tips, and funding strategies.',
    'index.card_career_title': 'Career Pathways',
    'index.card_career_desc': 'From studies to professional work opportunities globally.',
    'index.card_community_title': 'Student Community',
    'index.card_community_desc': 'Success stories, peer support, and networking opportunities.',
  ...
  ne: {
    ...
    'index.card_sch_desc': 'विश्वभरका सरकारी र विश्वविद्यालयका प्रमाणित अवसरहरू।',
    'index.card_visa_title': 'भिसा र आप्रवासन',
    'index.card_visa_desc': 'विद्यार्थी भिसा, कार्य अनुमति र आवासका चरणबद्ध मार्गहरू।',
    'index.card_prep_title': 'परीक्षा तयारी',
    'index.card_prep_desc': 'IELTS, TOEFL र अन्य मानकीकृत परीक्षाका स्रोतहरू।',
    'index.card_finance_title': 'वित्तीय योजना',
    'index.card_finance_desc': 'बजेट उपकरण, छात्रवृत्ति सुझाव र फन्डिङ रणनीतिहरू।',
    'index.card_career_title': 'करियर मार्गहरू',
    'index.card_career_desc': 'अध्ययनदेखि विश्वव्यापी व्यावसायिक कार्य अवसरहरूसम्म।',
    'index.card_community_title': 'विद्यार्थी समुदाय',
    'index.card_community_desc': 'सफलताका कथाहरू, साथीहरूको सहयोग र नेटवर्किङ अवसरहरू।',
  ...
  fr: {
    ...
    // New 6 categories
    'index.card_sch_title': 'Base de données de bourses',
    'index.card_sch_desc': 'Opportunités vérifiées des programmes gouvernementaux et universitaires mondiaux.',
    'index.card_visa_title': 'Visa et immigration',
    'index.card_visa_desc': 'Parcours étape par étape pour visas étudiants, permis de travail et résidence.',
    'index.card_prep_title': 'Préparation aux tests',
    'index.card_prep_desc': 'Ressources IELTS, TOEFL et autres tests standardisés.',
    'index.card_finance_title': 'Planification financière',
    'index.card_finance_desc': 'Outils de budgétisation, conseils de bourses et stratégies de financement.',
    'index.card_career_title': 'Parcours de carrière',
    'index.card_career_desc': 'Des études aux opportunités de travail professionnel mondial.',
    'index.card_community_title': 'Communauté étudiante',
    'index.card_community_desc': 'Histoires de succès, soutien entre pairs et opportunités de réseautage.',
    'index.mission_title': 'Mission',
  ...
  es: {
    ...
    // New 6 categories
    'index.card_sch_title': 'Base de datos de becas',
    'index.card_sch_desc': 'Oportunidades verificadas de programas gubernamentales y universitarios mundiales.',
    'index.card_visa_title': 'Visa e inmigración',
    'index.card_visa_desc': 'Rutas paso a paso para visas de estudiante, permisos de trabajo y residencia.',
    'index.card_prep_title': 'Preparación de exámenes',
    'index.card_prep_desc': 'Recursos de IELTS, TOEFL y otras pruebas estandarizadas.',
    'index.card_finance_title': 'Planificación financiera',
    'index.card_finance_desc': 'Herramientas de presupuesto, consejos de becas y estrategias de financiación.',
    'index.card_career_title': 'Trayectorias profesionales',
    'index.card_career_desc': 'Desde estudios hasta oportunidades de trabajo profesional global.',
    'index.card_community_title': 'Comunidad estudiantil',
    'index.card_community_desc': 'Historias de éxito, apoyo entre pares y oportunidades de networking.',
  ...
  ur: {
    ...
    'footer.links.privacy': 'پرائیویسی',
    ...
    'index.card_sch_desc': 'حکومتی اور یونیورسٹی پروگرامز کے تصدیق شدہ مواقع۔',
    'index.card_visa_title': 'ویزا اور امیگریشن',
    'index.card_visa_desc': 'طالب علم ویزا، ورک پرمٹ اور رہائش کے لیے قدم بہ قدم راستے۔',
    'index.card_prep_title': 'ٹیسٹ کی تیاری',
    'index.card_prep_desc': 'IELTS، TOEFL اور دیگر معیاری ٹیسٹس کے وسائل۔',
    'index.card_finance_title': 'مالی منصوبہ بندی',
    'index.card_finance_desc': 'بجٹ کے ٹولز، اسکالرشپ کے نکات اور فنڈنگ کی حکمت عملی۔',
    'index.card_career_title': 'کیریئر کے راستے',
    'index.card_career_desc': 'تعلیم سے لے کر عالمی پیشہ ورانہ کام کے مواقع تک۔',
    'index.card_community_title': 'طلبہ کمیونٹی',
    'index.card_community_desc': 'کامیابی کی کہانیاں، ساتھیوں کا سپورٹ اور نیٹ ورکنگ کے مواقع۔',
  ...
  hi: {
    ...
    'index.card_sch_desc': 'सरकारी और विश्वविद्यालय कार्यक्रमों के सत्यापित अवसर।',
    'index.card_visa_title': 'वीज़ा और आप्रवासन',
    'index.card_visa_desc': 'छात्र वीज़ा, कार्य परमिट और निवास के लिए चरणबद्ध मार्ग।',
    'index.card_prep_title': 'परीक्षा तैयारी',
    'index.card_prep_desc': 'IELTS, TOEFL और अन्य मानकीकृत परीक्षाओं के संसाधन।',
    'index.card_finance_title': 'वित्तीय योजना',
    'index.card_finance_desc': 'बजट उपकरण, छात्रवृत्ति सुझाव और फंडिंग रणनीतियाँ।',
    'index.card_career_title': 'करियर पथ',
    'index.card_career_desc': 'अध्ययन से लेकर वैश्विक व्यावसायिक कार्य अवसरों तक।',
    'index.card_community_title': 'छात्र समुदाय',
    'index.card_community_desc': 'सफलता की कहानियाँ, साथियों का समर्थन और नेटवर्किंग अवसर।',
    'index.mission_title': 'उद्देश्य',
