...
const I18N = {
  en: {
    ...
    'footer.links.students_stories': 'Students & Stories',
    'footer.links.ielts_prep': 'IELTS & Prep',
    ...
    // Old 3-card layout (keeping for backwards compatibility)
    ...
    // New 6-category layout
    'index.card_scholarships_title': 'Scholarship Database',
    'index.card_scholarships_desc': 'Browse 50+ verified opportunities by country, level, and funding type.',
    'index.card_visa_title': 'Visa & Immigration',
    'index.card_visa_desc': 'Clear pathways from student visa to permanent residency.',
    'index.card_test_prep_title': 'Test Preparation',
    'index.card_test_prep_desc': 'IELTS, TOEFL, and standardized test resources.',
    'index.card_financial_title': 'Financial Planning',
    'index.card_financial_desc': 'Budget planning, financial proof, and funding strategies for international education.',
    'index.card_career_title': 'Career Pathways',
    'index.card_career_desc': 'From student to professional: internships, work permits, and career development.',
    'index.card_community_title': 'Student Community',
    'index.card_community_desc': 'Connect with Nepali students worldwide, share experiences, and find mentorship.',
  ...
  ne: {
    ...
    'footer.links.students_stories': 'विद्यार्थी र कथाहरू',
    'footer.links.ielts_prep': 'IELTS र तयारी',
    'footer.links.contact': 'सम्पर्क',
    ...
    // New 6-category layout
    'index.card_scholarships_title': 'छात्रवृत्ति डाटाबेस',
    'index.card_scholarships_desc': '५०+ प्रमाणित अवसरहरू देश, स्तर र फन्डिङ प्रकार अनुसार हेर्नुहोस्।',
    'index.card_visa_title': 'भिसा र आप्रवासन',
    'index.card_visa_desc': 'विद्यार्थी भिसादेखि स्थायी निवास सम्मको स्पष्ट मार्गहरू।',
    'index.card_test_prep_title': 'परीक्षा तयारी',
    'index.card_test_prep_desc': 'IELTS, TOEFL र मानकीकृत परीक्षाका स्रोतहरू।',
    'index.card_financial_title': 'वित्तीय योजना',
    'index.card_financial_desc': 'अन्तर्राष्ट्रिय शिक्षाका लागि बजेट योजना, वित्तीय प्रमाण र फन्डिङ रणनीति।',
    'index.card_career_title': 'करियर मार्गहरू',
    'index.card_career_desc': 'विद्यार्थीदेखि पेशेवर सम्म: इन्टर्नशिप, कार्य परमिट र करियर विकास।',
    'index.card_community_title': 'विद्यार्थी समुदाय',
    'index.card_community_desc': 'विश्वव्यापी नेपाली विद्यार्थीहरूसँग जोडिनुहोस्, अनुभव साझा गर्नुहोस् र सल्लाह पाउनुहोस्।',
  ...
  fr: {
    ...
    'nav.guides': 'Guides',
    'nav.about': 'À propos',
    'nav.students_stories': 'Étudiants et histoires',
    'nav.ielts_prep': 'IELTS et préparation',
    'nav.contact': 'Contact',
    ...
    'footer.links.guides': 'Guides',
    'footer.links.students_stories': 'Étudiants et histoires',
    'footer.links.ielts_prep': 'IELTS et préparation',
    'footer.links.contact': 'Contact',
    ...
    // New 6-category layout
    'index.card_scholarships_title': 'Base de bourses',
    'index.card_scholarships_desc': 'Parcourez 50+ opportunités vérifiées par pays, niveau et type de financement.',
    'index.card_visa_title': 'Visa et immigration',
    'index.card_visa_desc': 'Parcours clairs du visa étudiant à la résidence permanente.',
    'index.card_test_prep_title': 'Préparation aux tests',
    'index.card_test_prep_desc': 'Ressources pour IELTS, TOEFL et tests standardisés.',
    'index.card_financial_title': 'Planification financière',
    'index.card_financial_desc': 'Planification budgétaire, preuves financières et stratégies de financement pour l\'éducation internationale.',
    'index.card_career_title': 'Parcours de carrière',
    'index.card_career_desc': 'De l\'étudiant au professionnel : stages, permis de travail et développement de carrière.',
    'index.card_community_title': 'Communauté étudiante',
    'index.card_community_desc': 'Connectez-vous avec des étudiants népalais du monde entier, partagez des expériences et trouvez du mentorat.',
    'index.mission_title': 'Mission',
  ...
  es: {
    ...
    'nav.guides': 'Guías',
    'nav.about': 'Acerca de',
    'nav.students_stories': 'Estudiantes e historias',
    'nav.ielts_prep': 'IELTS y preparación',
    ...
    'footer.links.students_stories': 'Estudiantes e historias',
    'footer.links.ielts_prep': 'IELTS y preparación',
    ...
    // New 6-category layout
    'index.card_scholarships_title': 'Base de becas',
    'index.card_scholarships_desc': 'Navega 50+ oportunidades verificadas por país, nivel y tipo de financiamiento.',
    'index.card_visa_title': 'Visa e inmigración',
    'index.card_visa_desc': 'Rutas claras desde visa de estudiante hasta residencia permanente.',
    'index.card_test_prep_title': 'Preparación de exámenes',
    'index.card_test_prep_desc': 'Recursos para IELTS, TOEFL y exámenes estandarizados.',
    'index.card_financial_title': 'Planificación financiera',
    'index.card_financial_desc': 'Planificación presupuestaria, pruebas financieras y estrategias de financiamiento para educación internacional.',
    'index.card_career_title': 'Rutas de carrera',
    'index.card_career_desc': 'De estudiante a profesional: pasantías, permisos de trabajo y desarrollo profesional.',
    'index.card_community_title': 'Comunidad estudiantil',
    'index.card_community_desc': 'Conecta con estudiantes nepaleses de todo el mundo, comparte experiencias y encuentra mentoría.',
  ...
  ur: {
    ...
    'nav.guides': 'رہنمائیں',
    'nav.about': 'تعارف',
    'nav.students_stories': 'طلبہ اور کہانیاں',
    'nav.ielts_prep': 'IELTS اور تیاری',
    'nav.contact': 'رابطہ',
    'nav.privacy': 'رازداری',
    ...
    'footer.links.students_stories': 'طلبہ اور کہانیاں',
    'footer.links.ielts_prep': 'IELTS اور تیاری',
    'footer.links.contact': 'رابطہ',
    'footer.links.privacy': 'رازداری',
    ...
    // New 6-category layout
    'index.card_scholarships_title': 'اسکالرشپس ڈیٹابیس',
    'index.card_scholarships_desc': '50+ مصدقہ مواقع ملک، سطح اور فنڈنگ کی قسم کے مطابق دیکھیں۔',
    'index.card_visa_title': 'ویزا اور امیگریشن',
    'index.card_visa_desc': 'طالب علم ویزا سے مستقل رہائش تک کے واضح راستے۔',
    'index.card_test_prep_title': 'ٹیسٹ کی تیاری',
    'index.card_test_prep_desc': 'IELTS، TOEFL اور معیاری ٹیسٹ کے وسائل۔',
    'index.card_financial_title': 'مالی منصوبہ بندی',
    'index.card_financial_desc': 'بین الاقوامی تعلیم کے لیے بجٹ پلاننگ، مالی ثبوت اور فنڈنگ کی حکمت عملیاں۔',
    'index.card_career_title': 'کیریئر کے راستے',
    'index.card_career_desc': 'طالب علم سے پیشہ ور تک: انٹرن شپ، ورک پرمٹ اور کیریئر ڈیولپمنٹ۔',
    'index.card_community_title': 'طلبہ کمیونٹی',
    'index.card_community_desc': 'دنیا بھر کے نیپالی طلبہ سے جڑیں، تجربات شیئر کریں اور رہنمائی حاصل کریں۔',
  ...
  hi: {
    ...
    'nav.guides': 'गाइड्स',
    'nav.about': 'परिचय',
    'nav.students_stories': 'छात्र और कहानियाँ',
    'nav.ielts_prep': 'IELTS और तैयारी',
    'nav.contact': 'संपर्क',
    'nav.privacy': 'गोपनीयता',
    ...
    'footer.links.students_stories': 'छात्र और कहानियाँ',
    'footer.links.ielts_prep': 'IELTS और तैयारी',
    ...
    // New 6-category layout
    'index.card_scholarships_title': 'छात्रवृत्ति डेटाबेस',
    'index.card_scholarships_desc': '50+ सत्यापित अवसर देश, स्तर और फंडिंग प्रकार के अनुसार देखें।',
    'index.card_visa_title': 'वीज़ा और आप्रवासन',
    'index.card_visa_desc': 'स्टूडेंट वीज़ा से पर्मानेंट रेजिडेंसी तक के स्पष्ट मार्ग।',
    'index.card_test_prep_title': 'टेस्ट की तैयारी',
    'index.card_test_prep_desc': 'IELTS, TOEFL और मानकीकृत परीक्षाओं के संसाधन।',
    'index.card_financial_title': 'वित्तीय योजना',
    'index.card_financial_desc': 'अंतर्राष्ट्रीय शिक्षा के लिए बजट प्लानिंग, वित्तीय प्रमाण और फंडिंग रणनीतियां।',
    'index.card_career_title': 'करियर मार्ग',
    'index.card_career_desc': 'छात्र से पेशेवर तक: इंटर्नशिप, वर्क परमिट और करियर डेवलपमेंट।',
    'index.card_community_title': 'छात्र समुदाय',
    'index.card_community_desc': 'दुनिया भर के नेपाली छात्रों से जुड़ें, अनुभव साझा करें और मार्गदर्शन प्राप्त करें।',
    'index.mission_title': 'उद्देश्य',
